tab_overview_ca <- fluidPage(
  ...
  fluidRow(
           ...
           fluidRow(
             column(12, 
                    box(
                      ...
                      width = 12,
                      height = 700,
                      leaflet::leafletOutput("map_cases_ca", height = 640)
                    )
             )
           )
    )
    ...
    #          # width = 12,
    #          height = 275,
    #          title = "Reported Lyme Disease Cases, 2009-2018",
    #          plotlyOutput("plot_historical_cases_ca", height = "200px")
    #        )
    # )
  )
)
